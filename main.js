...
addProject('API REST + MongoDB', 'Mi primer proyecto para la certificación de "Desarrollador Backend", creando mi primera API con Node.js, haciendo uso de Express para la conexión y MongoDB para la base de datos', "https://github.com/AMelendez-27/Proyecto_6_API_REST")
